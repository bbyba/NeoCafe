...
internal enum S {
  ...
  /// Отмена
  internal static let cancel = S.tr("Localizable", "cancel", fallback: "Отмена")
  /// Корзина
  ...
  /// Завершенные
  internal static let finished = S.tr("Localizable", "finished", fallback: "Завершенные")
  /// Получить код
  ...
  /// Открытый заказ
  internal static let openOrder = S.tr("Localizable", "openOrder", fallback: "Открытый заказ")
  /// Заказать
  ...
  /// Отлично!
  internal static let perfect = S.tr("Localizable", "perfect", fallback: "Отлично!")
  /// Приятное дополнение
  ...
  /// Списать
  internal static let use = S.tr("Localizable", "use", fallback: "Списать")
  /// Списание бонусов
